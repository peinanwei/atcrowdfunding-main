									...
									<div class="col-md-12 column" style="padding: 0 120px;">
										<div class="radio">
											<label> <input type="radio" name="optionsRadios"
												id="optionsRadios1" value="option1" checked> xxxxx
												188****3342 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
											</label>
										</div>
										<div class="radio">
											<label> <input type="radio" name="optionsRadios"
												id="optionsRadios2" value="option2"> xxxxx
												188****3342 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
											</label>
										</div>
										<div class="radio">
									...
									<div class="col-md-12 column">
										<blockquote
											...
											<b> 项目信息 <a style="font-size: 12px;"
												href="${APP_PATH }/trade/pay-step-1.htm">修改数量</a>
											</b>
										</blockquote>
									</div>
									<div class="col-md-12 column">
										...
										<div class="alert alert-warning alert-dismissable"
											...
											<ul style="list-style: none;">
												...
												<li style="margin-top: 10px; margin-bottom: 10px;"><h2>
														支付总金额：<span style="color: red;">￥1.00</span>
													</h2></li>
												<li
												...
												<li style="margin-top: 10px;">
													<button disabled="disabled" type="button"
														...
														onclick="window.location.href='${APP_PATH }/trade/pay-step-3.htm'">

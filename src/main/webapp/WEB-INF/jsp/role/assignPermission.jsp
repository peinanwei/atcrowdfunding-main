        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
                  <button onclick="editData()" class="btn btn-success">分配许可</button>
                  <br><br>
	...
	<script src="${APP_PATH }/ztree/jquery.ztree.all-3.5.min.js"></script>
        <script type="text/javascript">
            ...
            function zTreeOnAsyncSuccess(event, treeId, treeNode, msg) {
    			...
    			$.ajax({
    				url:"${APP_PATH}/role/getData.do",
    				type:"post",
    				data:obj,
    				success:function(result){
    					var treeObj = $.fn.zTree.getZTreeObj("treeDemo");
    					var nodes = treeObj.getCheckedNodes(false);
    					 $.each(result,function(i,perid){
    						$.each(nodes,function(i,node){
    							if(perid == node.id && node.children.length ==0){
			...
			function editData(){
				...
				$.each(nodes,function(i,node){
					obj["dataIds["+i+"]"]=node.id;
				})
				
				$.ajax({
					url:"${APP_PATH}/role/editData.do",
					type:"post",
					data:obj,
					success:function(result){
						var treeObj = $.fn.zTree.getZTreeObj("treeDemo");
						treeObj.reAsyncChildNodes(null, "refresh");
						layer.msg("分配权限成功", {time:1000, icon:6, shift:6});
					}
				})
			}

					...
					<div class="panel panel-default">
												...
												<div class="col-sm-10">
													<ul style="list-style: none; padding-left: 0;">
														<li style="margin: 10px 0">[手机] <span
															class="label-txt">手机</span> <span class="label-txt">快充</span>
															<span class="label-txt">文字标签</span> <span
															class="label-txt">文字标签</span> <span class="label-txt">文字标签</span>
															<span class="label-txt">文字标签</span>
														</li>
						...
						<div class="panel-footer" style="text-align: center;">
							<button type="button" class="btn  btn-warning btn-lg"
								onclick="window.location.href='${APP_PATH}/project/start-step-2.htm'">下一步</button>
						</div>
					</div>
				</div>
			</div>

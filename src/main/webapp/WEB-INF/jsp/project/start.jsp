				...
				<div class="col-md-12 column">
					<div class="panel panel-default">
						...
						<div class="panel-body"
							style="height: 400px; overflow-y: auto; padding: 10px;">
							<div class="test-box">
								<p>
									<b>在发起人使用尚筹网众筹平台提供的服务之前，请务必认真阅读本协议的全部内容。阅读本协议的过程中，如您不同意本协议或其中任何条款约定，您应立即停止注册（如：点击确认等后续操作），撤销注册流程。本协议一经发起人点击确认并同意接受，即产生法律效力。
									</b>
								</p>
								<h5>第1条 签约主体</h5>
								<p>本协议由尚筹网网站（包括但不限于www.atcrowd.com及尚筹网众筹平台）的所有者及其关联公司（以下简称为“尚筹网”），在尚筹网众筹平台（zc.atcrowd.com）与登录、使用尚筹网众筹平台的项目发起人（以下简称
								...
								<p>6.7
									项目的排他性，项目在尚筹网众筹平台募集期内不得在其他任意平台同时发起类似项目或进行销售。一经发现，项目强行下架，并追究违约责任。</p>
								...
								<p>
									7.3项目回报产品在尚筹网众筹平台设置的最高单价应低于项目成功结束后<b>两个月内</b>的产品市场售价的<b>90%</b>
									，否则应将售价差额发还支持者。
								</p>
								...
								<p>
									8.7发起人在项目回报日前未完成回报，且无合理理由的，视为项目延期。<b>项目延期30天（含）以上的，视为项目失败</b>。尚筹网众筹平台有权通过系统直接向未确认收货的支持者退还支持款，发起人应当将支持款全额返还尚筹网众筹平台。
								</p>
								...
								<p>
									9.1尚筹网众筹平台对支持款的交付及平台服务费的收取均通过第三方支付平台<b>尚筹网易付宝</b>进行收付。
								</p>
								...
								<p>
									1.4为保证产品在<strong><u>1年保修期</u></strong>内的售后服务质量，发起人须向尚筹网缴纳质量保证金（简称“质保金”），作为尚筹网处理客户投诉或产品质量问题用：
								</p>
								<p>
									若发起人为尚筹网（或尚筹网关联公司）已有合作方的，与已有合作业务关联，以尚筹网（或尚筹网关联公司）对发起人的应付账款作为质押，包括但不限于货款、保证金等。
								</p>
								<p>
									若发起人非尚筹网（或尚筹网关联公司）已有合作方的，在项目筹款成功后，尚筹网从项目所筹得款项中自动扣取下述约定金额作为质量保证金，自所有支持者收到回报产品<strong><u>
											1年</u></strong>以后，且发起人已经妥善处理所有客户投诉后，尚筹网将此质保金返还发起人，具体金额要求如下：
								</p>
								<table class="table-initiate">
									<tbody>
										...
										<tr>
											...
											<td rowspan="9">下限：1000元<br> 上限：10万元<br>
								...
								<p>
									4.2对于发起人应当承担的违约金，尚筹网或尚筹网众筹平台有权从发起人的保证金及质保金或其他由尚筹网或尚筹网众筹平台控制的款项中直接抵扣，不予返还。<b>保证金及质保金不足以支付的，尚筹网或尚筹网众筹平台均有权继续向发起人追偿。</b>
								</p>
								<h5>5、 其他</h5>
						...
						<div class="panel-footer" style="text-align: center;">
							<button type="button" class="btn  btn-warning btn-lg"
								onclick="window.location.href='${APP_PATH }/project/start-step-1.htm'">阅读并同意协议</button>
						</div>
					</div>
				</div>
			</div>

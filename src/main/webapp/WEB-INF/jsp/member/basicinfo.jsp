...
<body>
		...
		<form role="form" style="margin-top: 20px;">
			<div class="form-group">
				<label for="exampleInputEmail1">真实名称</label> <input type="text"
					class="form-control" id="realname" placeholder="请输入真实名称">
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">身份证号码</label> <input type="text"
					class="form-control" id="cardnum"
			...
			<button type="button" onclick="window.location.href='${APP_PATH}/user/accttype.htm'"
	...
	<script>
		...
		$("#nextBtn").click(function(){
			$.ajax({
				url : "${APP_PATH}/member/updateBasicinfo.htm",
				type : "post",
				data : {
